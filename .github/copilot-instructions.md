...
- For cross-platform Linux/macOS migration, prefer using Photino with htmx and avoid heavy JavaScript frameworks. Assess feasibility before implementation.
